...
const translations: Translations = {
  en: {
    ...
    'testimonials.2.title': 'Travel Blogger',
    ...
    'testimonials.3.title': 'Investment Broker',
    ...
    'checkout.progress.checkout': 'Checkout',
    'checkout.progress.payment': 'Payment',
    'checkout.progress.confirmation': 'Confirmation',
    'checkout.customerInfo.title': 'Customer Information',
    'checkout.customerInfo.fullName': 'Full Name',
    'checkout.customerInfo.fullNamePlaceholder': 'Enter your full name',
    'checkout.customerInfo.email': 'Email',
    'checkout.customerInfo.emailPlaceholder': 'your@email.com',
    'checkout.customerInfo.phone': 'Phone Number',
    'checkout.customerInfo.tourDate': 'Tour Date',
    'checkout.customerInfo.selectDate': 'Select a date',
    'checkout.customerInfo.participants': 'Number of Participants',
    'checkout.customerInfo.selectParticipants': 'Select number',
    'checkout.customerInfo.specialRequests': 'Special Requests',
    'checkout.customerInfo.specialRequestsPlaceholder': 'Any special requests or requirements?',
    'checkout.customerInfo.dietary': 'Dietary Restrictions',
    'checkout.customerInfo.dietary.vegetarian': 'Vegetarian',
    'checkout.customerInfo.dietary.vegan': 'Vegan',
    'checkout.customerInfo.dietary.glutenFree': 'Gluten-free',
    'checkout.payment.title': 'Payment Method',
    'checkout.payment.sbp': 'Fast Bank Transfer (SBP)',
    'checkout.payment.sbpDescription': 'Instant payment via Fast Payment System',
    'checkout.agreements.title': 'Legal Agreements',
    'checkout.agreements.privacy': 'I agree to the',
    'checkout.agreements.privacyLink': 'Privacy Policy',
    'checkout.agreements.terms': 'I accept the',
    'checkout.agreements.termsLink': 'Terms of Service',
    'checkout.agreements.confirmation': 'I confirm the booking details are correct',
    ...
    // Budget Experiences
    'catalog.budget.scooter.title': 'Budget Scooter Rental',
    'catalog.budget.scooter.description': 'Perfect for exploring Phuket, Samui, or Pattaya on a budget. Reliable automatic scooters 110-125 cc, full insurance, and basic protective gear included. Ideal for daily trips to the beach and around the city. Minimum rental: 3 days.',
    'catalog.budget.motorcycle.title': 'Motorcycle Rental (600-1200 cc)',
    'catalog.budget.motorcycle.description': 'Experience Thailand\'s mountain roads and scenic coastal routes on powerful motorcycles. Choose from Honda CB500X, Kawasaki Versys 650, or BMW GS1200. Full comprehensive insurance, protective gear, and detailed route maps included. Ideal for experienced riders seeking adventure.',
    'catalog.budget.biketour.title': 'Organized Motorbike Tour - Coastal Route',
    'catalog.budget.biketour.description': 'A full-day organized motorbike tour along Thailand\'s most scenic coastal roads. Pass through fishing villages, viewpoints, and hidden beaches. Experienced guide, motorcycle rental (Honda CB500X), lunch at a local restaurant, and all protective gear included. Small groups (max. 6 riders).',
    'catalog.budget.templetour.title': 'Group Temple Tour',
    'catalog.budget.templetour.description': 'Join a small group (8-12 people) for an engaging half-day journey to the most beautiful temples of Bangkok or Chiang Mai. Visit Wat Pho, Wat Arun, and Wat Phra Kaew with a knowledgeable local guide who shares history and cultural insights. Comfortable air-conditioned transport included.',
    'catalog.budget.island.title': 'Group Island Speedboat Tour',
    'catalog.budget.island.description': 'Discover the stunning islands around Phuket, Krabi, or Samui on a group speedboat. Visit 4-5 islands, including Maya Bay, Phi-Phi, and hidden lagoons. Snorkeling equipment, a beach buffet lunch, and a professional guide are included. Daily departure at 8:30.',
    'catalog.budget.cooking.title': 'Thai Cooking Masterclass',
    'catalog.budget.cooking.description': 'Learn to cook authentic Thai dishes in a traditional kitchen with a local chef. Visit a morning market to select fresh ingredients, then prepare 5 classic dishes, including Pad Thai, Green Curry, and Mango with Sticky Rice. Take home recipes and cooking techniques. Vegetarian options are available.',
    'catalog.budget.snorkeling.title': 'Coral Reef Snorkeling Adventure',
    'catalog.budget.snorkeling.description': 'Explore vibrant coral reefs teeming with tropical fish. Perfect for beginners and families. Visit 2-3 snorkeling spots with crystal-clear water. All equipment, life vests, an underwater guide, and light snacks are included. A 4-hour experience with hotel transfer.',
    'catalog.budget.foodtour.title': 'Night Market Food Tour',
    'catalog.budget.foodtour.description': 'Immerse yourself in Thai street food culture with a local foodie guide. Visit the best stalls of a night market, try 8-10 authentic dishes, and learn about Thai culinary traditions. All food tastings, desserts, and drinks are included. Discover hidden gems loved by locals. Evening tour (18:00 - 21:00).',

    // Budget Add-ons
    'addons.budget.scooter.helmet.title': 'Upgraded Helmet',
    'addons.budget.scooter.helmet.description': 'Upgrade to a full-face helmet with a Bluetooth module.',
    'addons.budget.scooter.gps.title': 'GPS Navigator',
    'addons.budget.scooter.gps.description': 'Garmin GPS with pre-installed maps.',
    'addons.budget.scooter.insurance.title': 'Zero-Deductible Insurance',
    'addons.budget.scooter.insurance.description': 'Upgrade to comprehensive insurance with zero deductible.',
    'addons.budget.motorcycle.gear.title': 'Professional Protective Gear',
    'addons.budget.motorcycle.gear.description': 'Full set of protection (jacket, pants, gloves, and boots).',
    'addons.budget.motorcycle.luggage.title': 'Waterproof Luggage',
    'addons.budget.motorcycle.luggage.description': 'Spacious, waterproof luggage for long-distance trips.',
    'addons.budget.motorcycle.tracker.title': 'GPS Tracker & Emergency Assistance',
    'addons.budget.motorcycle.tracker.description': 'GPS tracker with a 24/7 emergency hotline.',
    'addons.budget.biketour.seafood.title': 'Seafood Lunch',
    'addons.budget.biketour.seafood.description': 'Upgrade to a lunch with fresh seafood at a beachfront restaurant.',
    'addons.budget.biketour.gopro.title': 'GoPro Video Package',
    'addons.budget.biketour.gopro.description': 'Helmet-mounted GoPro recording with an edited video.',
    'addons.budget.biketour.transfer.title': 'Transfer',
    'addons.budget.biketour.transfer.description': 'Convenient transfer from your hotel to the tour starting point and back.',
    'addons.budget.templetour.lunch.title': 'Traditional Thai Lunch',
    'addons.budget.templetour.lunch.description': 'Authentic Thai lunch at a local riverside restaurant.',
    'addons.budget.templetour.photo.title': 'Professional Photo Package',
    'addons.budget.templetour.photo.description': '50+ edited photos from your temple visit.',
    'addons.budget.templetour.transfer.title': 'Private Hotel Transfer',
    'addons.budget.templetour.transfer.description': 'Private car instead of group transport.',
    'addons.budget.island.snorkel.title': 'Premium Snorkeling Gear',
    'addons.budget.island.snorkel.description': 'High-quality mask with diopters and full-size fins.',
    'addons.budget.island.bbq.title': 'Seafood BBQ Lunch',
    'addons.budget.island.bbq.description': 'Upgrade to a lunch with a grill of fresh seafood on the beach.',
    'addons.budget.island.gopro.title': 'Underwater GoPro Rental',
    'addons.budget.island.gopro.description': 'GoPro camera with a waterproof housing for the day.',
    'addons.budget.cooking.market.title': 'Extended Market Tour',
    'addons.budget.cooking.market.description': 'A longer market visit with a tasting of exotic ingredients.',
    'addons.budget.cooking.book.title': 'Recipe Book & Apron',
    'addons.budget.cooking.book.description': 'Hardcover recipe book and a custom embroidered apron.',
    'addons.budget.cooking.transport.title': 'Hotel Transport',
    'addons.budget.cooking.transport.description': 'Convenient transfer from your hotel to the starting point and back.',
    'addons.budget.snorkeling.gear.title': 'Upgraded Snorkeling Gear',
    'addons.budget.snorkeling.gear.description': 'High-quality mask, fins, and a rash guard for sun protection.',
    'addons.budget.snorkeling.photo.title': 'Underwater Photo Session',
    'addons.budget.snorkeling.photo.description': 'Professional underwater photos (30+ edited shots).',
    'addons.budget.snorkeling.instructor.title': 'Private Instructor',
    'addons.budget.snorkeling.instructor.description': 'Personal guide for beginners or families with children.',
    'addons.budget.foodtour.extra.title': 'Extra Tastings',
    'addons.budget.foodtour.extra.description': 'Additional 5 food and dessert tastings.',
    'addons.budget.foodtour.private.title': 'Private Food Guide',
    'addons.budget.foodtour.private.description': 'Upgrade to a private food tour (your group only).',
    'addons.budget.foodtour.transport.title': 'Hotel Transfer',
    'addons.budget.foodtour.transport.description': 'Convenient transfer from your hotel to the starting point and back.',
  ...
  ru: {
    ...
    'testimonials.2.title': 'Travel блоггер',
    ...
    'testimonials.3.title': 'Инвестиционный брокер',
    ...
    // Checkout Page
    'checkout.title': 'Оформление бронирования',
    'checkout.progress.cart': 'Корзина',
    'checkout.progress.checkout': 'Оформление',
    'checkout.progress.payment': 'Оплата',
    'checkout.progress.confirmation': 'Подтверждение',
    'checkout.customerInfo.title': 'Информация о клиенте',
    'checkout.customerInfo.fullName': 'Полное имя',
    'checkout.customerInfo.fullNamePlaceholder': 'Введите ваше полное имя',
    'checkout.customerInfo.email': 'Email',
    'checkout.customerInfo.emailPlaceholder': 'ваш@email.com',
    'checkout.customerInfo.phone': 'Номер телефона',
    'checkout.customerInfo.tourDate': 'Дата тура',
    'checkout.customerInfo.selectDate': 'Выберите дату',
    'checkout.customerInfo.participants': 'Количество участников',
    'checkout.customerInfo.selectParticipants': 'Выберите количество',
    'checkout.customerInfo.specialRequests': 'Особые пожелания',
    'checkout.customerInfo.specialRequestsPlaceholder': 'Есть ли особые пожелания или требования?',
    'checkout.customerInfo.dietary': 'Ограничения в питании',
    'checkout.customerInfo.dietary.vegetarian': 'Вегетарианец',
    'checkout.customerInfo.dietary.vegan': 'Веган',
    'checkout.customerInfo.dietary.glutenFree': 'Без глютена',
    'checkout.payment.title': 'Способ оплаты',
    'checkout.payment.sbp': 'Быстрый перевод (СБП)',
    'checkout.payment.sbpDescription': 'Мгновенная оплата через Систему Быстрых Платежей',
    'checkout.agreements.title': 'Юридические соглашения',
    'checkout.agreements.privacy': 'Я согласен с',
    'checkout.agreements.privacyLink': 'Политикой конфиденциальности',
    'checkout.agreements.terms': 'Я принимаю',
    'checkout.agreements.termsLink': 'Условия обслуживания',
    'checkout.agreements.confirmation': 'Я подтверждаю правильность деталей бронирования',
    'checkout.summary.title': 'Итоги заказа',
    ...
    // Budget Experiences
    'catalog.budget.scooter.title': 'Бюджетная аренда скутера',
    'catalog.budget.scooter.description': 'Идеально для исследования Пхукета, Самуи или Паттайи с ограниченным бюджетом. Надежные автоматические скутеры 110-125 куб.см, полная страховка и базовая защитная экипировка включены. Идеален для ежедневных поездок на пляж и по городу. Минимальный срок аренды: 3 дня.',
    'catalog.budget.motorcycle.title': 'Аренда мотоцикла (600-1200 куб.см)',
    'catalog.budget.motorcycle.description': 'Испытайте горные дороги и живописные прибрежные маршруты Таиланда на мощных мотоциклах. Выбирайте из Honda CB500X, Kawasaki Versys 650 или BMW GS1200. Полная комплексная страховка, защитная экипировка и подробные карты маршрутов включены. Идеально для опытных райдеров, ищущих приключений.',
    'catalog.budget.biketour.title': 'Организованный мототур — Прибрежный маршрут',
    'catalog.budget.biketour.description': 'Полнодневный организованный мототур по самым живописным прибрежным дорогам Таиланда. Проезжайте через рыбацкие деревни, смотровые площадки и скрытые пляжи. Опытный гид, аренда мотоцикла (Honda CB500X), обед в местном ресторане и вся защитная экипировка включены. Небольшие группы (макс. 6 райдеров).',
    'catalog.budget.templetour.title': 'Групповой тур по храмам',
    'catalog.budget.templetour.description': 'Присоединяйтесь к небольшой группе (8-12 человек) для увлекательного полудневного путешествия к самым красивым храмам Бангкока или Чиангмая. Посетите Ват Пхо, Ват Арун и Ват Пхра Кео с опытным местным гидом, который делится историей и культурными особенностями. Комфортабельный транспорт с кондиционером включен.',
    'catalog.budget.island.title': 'Групповой тур на скоростной лодке к островам',
    'catalog.budget.island.description': 'Откройте для себя потрясающие острова вокруг Пхукета, Краби или Самуи на групповой скоростной лодке. Посетите 4-5 островов, включая Майя Бэй, Пхи-Пхи и скрытые лагуны. Оборудование для снорклинга, пляжный буфетный обед и профессиональный гид включены. Ежедневный отправление в 8:30.',
    'catalog.budget.cooking.title': 'Мастер-класс по тайской кухне',
    'catalog.budget.cooking.description': 'Научитесь готовить аутентичные тайские блюда на традиционной кухне с местным шеф-поваром. Посетите утренний рынок для выбора свежих ингредиентов, затем приготовьте 5 классических блюд, включая Пад Тай, Зеленое Карри и Манго с клейким рисом. Заберите домой рецепты и кулинарные техники. Доступны вегетарианские варианты.',
    'catalog.budget.snorkeling.title': 'Приключение со снорклингом на коралловых рифах',
    'catalog.budget.snorkeling.description': 'Исследуйте яркие коралловые рифы, изобилующие тропическими рыбами. Идеально для новичков и семей. Посетите 2-3 места для снорклинга с кристально чистой водой. Все оборудование, спасательные жилеты, подводный гид и легкие закуски включены. 4-часовой опыт с трансфером от отеля.',
    'catalog.budget.foodtour.title': 'Гастрономический тур по ночному рынку',
    'catalog.budget.foodtour.description': 'Погрузитесь в культуру тайской уличной еды с местным гидом-гурманом. Посетите лучшие лотки ночного рынка, попробуйте 8-10 аутентичных блюд и узнайте о тайских кулинарных традициях. Все дегустации, десерты и напитки включены. Откройте для себя скрытые жемчужины, любимые местными жителями. Вечерний тур (18:00 - 21:00).',

    // Budget Add-ons
    'addons.budget.scooter.helmet.title': 'Улучшенный шлем',
    'addons.budget.scooter.helmet.description': 'Обновитесь до полнолицевого шлема с Bluetooth модулем.',
    'addons.budget.scooter.gps.title': 'GPS навигатор',
    'addons.budget.scooter.gps.description': 'Garmin GPS с предустановленными картами.',
    'addons.budget.scooter.insurance.title': 'Страховка без франшизы',
    'addons.budget.scooter.insurance.description': 'Обновитесь до комплексной страховки без франшизы.',
    'addons.budget.motorcycle.gear.title': 'Профессиональная защитная экипировка',
    'addons.budget.motorcycle.gear.description': 'Полный комплект защиты (куртка, штаны, перчатки и ботинки).',
    'addons.budget.motorcycle.luggage.title': 'Водонепроницаемый багаж',
    'addons.budget.motorcycle.luggage.description': 'Вместительный водонепроницаемый багаж для дальних поездок.',
    'addons.budget.motorcycle.tracker.title': 'GPS трекер и экстренная помощь',
    'addons.budget.motorcycle.tracker.description': 'GPS трекер с круглосуточной горячей линией экстренной помощи.',
    'addons.budget.biketour.seafood.title': 'Обед из морепродуктов',
    'addons.budget.biketour.seafood.description': 'Обновитесь до обеда со свежими морепродуктами в ресторане на берегу.',
    'addons.budget.biketour.gopro.title': 'Видео пакет GoPro',
    'addons.budget.biketour.gopro.description': 'Запись на шлем-камеру GoPro с отредактированным видео.',
    'addons.budget.biketour.transfer.title': 'Трансфер',
    'addons.budget.biketour.transfer.description': 'Удобный трансфер от вашего отеля до точки начала тура и обратно.',
    'addons.budget.templetour.lunch.title': 'Традиционный тайский обед',
    'addons.budget.templetour.lunch.description': 'Аутентичный тайский обед в местном ресторане на берегу реки.',
    'addons.budget.templetour.photo.title': 'Профессиональный фото пакет',
    'addons.budget.templetour.photo.description': '50+ отредактированных фотографий с вашего визита в храм.',
    'addons.budget.templetour.transfer.title': 'Приватный трансфер от отеля',
    'addons.budget.templetour.transfer.description': 'Частная машина вместо группового транспорта.',
    'addons.budget.island.snorkel.title': 'Премиум оборудование для снорклинга',
    'addons.budget.island.snorkel.description': 'Качественная маска с диоптриями и полноразмерные ласты.',
    'addons.budget.island.bbq.title': 'Барбекю обед из морепродуктов',
    'addons.budget.island.bbq.description': 'Обновитесь до обеда с грилем свежих морепродуктов на пляже.',
    'addons.budget.island.gopro.title': 'Аренда подводной GoPro',
    'addons.budget.island.gopro.description': 'Камера GoPro с водонепроницаемым корпусом на день.',
    'addons.budget.cooking.market.title': 'Расширенная экскурсия по рынку',
    'addons.budget.cooking.market.description': 'Более длительный визит на рынок с дегустацией экзотических ингредиентов.',
    'addons.budget.cooking.book.title': 'Книга рецептов и фартук',
    'addons.budget.cooking.book.description': 'Книга рецептов в твердом переплете и индивидуальный вышитый фартук.',
    'addons.budget.cooking.transport.title': 'Трансфер от отеля',
    'addons.budget.cooking.transport.description': 'Удобный трансфер от вашего отеля до точки начала и обратно.',
    'addons.budget.snorkeling.gear.title': 'Улучшенное оборудование для снорклинга',
    'addons.budget.snorkeling.gear.description': 'Качественная маска, ласты и рашгард для защиты от солнца.',
    'addons.budget.snorkeling.photo.title': 'Подводная фотосессия',
    'addons.budget.snorkeling.photo.description': 'Профессиональные подводные фотографии (30+ отредактированных снимков).',
    'addons.budget.snorkeling.instructor.title': 'Частный инструктор',
    'addons.budget.snorkeling.instructor.description': 'Персональный гид для новичков или семей с детьми.',
    'addons.budget.foodtour.extra.title': 'Дополнительные дегустации',
    'addons.budget.foodtour.extra.description': 'Дополнительные 5 дегустаций еды и десертов.',
    'addons.budget.foodtour.private.title': 'Частный гастрономический гид',
    'addons.budget.foodtour.private.description': 'Обновитесь до частного гастрономического тура (только ваша группа).',
    'addons.budget.foodtour.transport.title': 'Трансфер от отеля',
    'addons.budget.foodtour.transport.description': 'Удобный трансфер от вашего отеля до точки начала и обратно.',
