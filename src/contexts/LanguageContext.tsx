...
const translations: Translations = {
  en: {
    ...
    // Palace Add-ons
    'addons.palace.photo': 'Royal-Style Photo Session: Transform your palace visit into your own photographic chronicle. You will receive a collection of emotional and exquisite photographs that will become the most vibrant memory of your journey to Bangkok.',
    'addons.palace.lunch': 'Gastronomic Experience: Lunch at Le Normandie Restaurant (per person, wine pairing included): We will reserve a table for you at the legendary Le Normandie restaurant (🌟🌟 Michelin), located at Mandarin Oriental Bangkok. This is the epitome of French cuisine and impeccable service with panoramic river views of the Chao Phraya.',
    'addons.palace.transport': 'Impeccable Transfer: Rolls-Royce Phantom: You will be accompanied throughout the entire route in a Rolls-Royce Phantom with a personal driver. This guarantees the highest level of comfort, confidentiality, and status.',
    
    // Ayutthaya Add-ons
    'addons.ayutthaya.photo': '"History and Light" Photo Session: Our photographer, whose work is published in travel magazines, will not just take pictures but create a portfolio for you in the spirit of artistic historical chronicles. Using the unique "sunset" lighting among ancient ruins, they will capture your journey as a narrative full of aesthetics and emotions.',
    'addons.ayutthaya.dinner': 'Gastronomic Experience: Dinner at Rongros Restaurant (per person, beverages included): We will reserve a table for you at the famous Rongros restaurant (🌟 Michelin), located in the historic Rattanakosin district right on the Chao Phraya River waterfront. You can enjoy authentic Thai cuisine of the highest level with a view of Wat Arun in the rays of the setting sun - the perfect end to the day.',
    'addons.ayutthaya.guide': 'In-Depth Program: Ayutthaya Heritage Expert Guide: Your guide will be a recognized expert, author of scientific works or guest lecturer, who will reveal secrets not described in guidebooks. This option includes access to one of the lesser-known historical sites by prior arrangement and detailed artifact analysis.',
    
    // Floating Markets Add-ons
    'addons.floating.photo': 'Travel Journalism-Style Photo Essay: Our photographer, specializing in documentary and travel photography, will create a living and emotional story in pictures for you, not staged photos. You will receive a series of images that convey the authentic atmosphere of the market, the colors of goods, and the characters of local people.',
    'addons.floating.breakfast': 'Gastronomic Start to the Day: Breakfast at Mandarin Oriental Bangkok (per person): Begin your day with an exquisite breakfast at the legendary Mandarin Oriental. At The Verandah restaurant, a luxurious buffet with dishes of international and Thai cuisine of the highest class awaits you, served with impeccable attention to detail before departure on your tour.',
    'addons.floating.transport': 'Impeccable Transfer: Premium Mercedes-Benz V-Class Van: Your journey to the market and back will be conducted with maximum comfort in a spacious and quiet Mercedes-Benz V-Class van. Air-conditioned cabin, leather seats, and a professional driver guarantee a relaxing and smooth ride along scenic suburban roads.',
    
    // Temples Add-ons
    'addons.temples.photo': '"Dialogue with Eternity" Photo Session: Our photographer, specializing in artistic and architectural photography, will create a portfolio for you where you become part of the sacred space. Using the play of light and shadow in temple complexes, they will capture moments of deep cultural immersion, creating timeless photographs in the aesthetics of high art.',
    'addons.temples.meditation': 'Deep Immersion: Meditation with Monk Mentor: This is not a group session but a personal audience and spiritual consultation. You will spend the necessary time in a secluded cell or temple garden with a monk who will answer all your questions about life and the philosophy of Dharma and teach you personal meditation techniques tailored to your needs.',
    'addons.temples.transport': 'Premium Transfer: Lexus LX Business SUV: Move through bustling Bangkok in impeccable comfort and quietness in a luxurious Lexus LX SUV. Spacious cabin with climate control, leather trim, and professional driver services will ensure a state of serenity and smooth transition between worldly bustle and spiritual oases.',
    
    // Tribes Add-ons
    'addons.tribes.photo': 'Documentary Photography: "Keepers of Traditions": Our photographer, working in the genre of documentary anthropology, will create a unique photo diary for you. These will not be staged shots but a piercing artistic chronicle of your journey - portraits of masters at work, moments of rituals, and landscapes of lost worlds worthy of publication.',
    'addons.tribes.accommodation': 'Eco-Luxury Accommodation: Private Rainforest Camp (for entire expedition): Forgo standard guesthouses in favor of a premium eco-camping experience. Your accommodation is a luxury tent with a king-size bed, private bathroom with shower, and panoramic jungle views. In the evening, candlelit dinner and a jacuzzi under the starry sky await you.',
    'addons.tribes.chef': 'Gastronomic Experience: Personal Chef (for entire expedition): Forget standard group lunches. Throughout the expedition, your meals will be supervised by a personal chef who will prepare high Thai cuisine dishes from local products for you. You can participate in master classes on preparing traditional dishes of mountain tribes in the format of a private outdoor culinary show.',
  ...
  ru: {
    ...
    // Palace Add-ons
    'addons.palace.photo': 'Арт-сопровождение: фотосессия в королевском стиле: Превратите визит во дворец в собственную фото-летопись. Вы получите коллекцию эмоциональных и изысканных фотографий, которые станут самым ярким воспоминанием о вашем путешествии в Бангкок.',
    'addons.palace.lunch': 'Гастрономический опыт: обед в ресторане Le Normandie (на персону, включена дегустационная пара вин): Мы забронируем для вас стол в легендарном ресторане Le Normandie (🌟🌟 Michelin), расположенном в отеле Mandarin Oriental Bangkok. Это эталон французской кухни и безупречного сервиса с панорамным видом на реку Чаопрайя.',
    'addons.palace.transport': 'Безупречный трансфер: автомобиль Rolls-Royce Phantom: Вас будут сопровождать на протяжении всего маршрута в автомобиле Rolls-Royce Phantom с персональным водителем. Это гарантирует высочайший уровень комфорта, конфиденциальности и статуса.',
    
    // Ayutthaya Add-ons
    'addons.ayutthaya.photo': 'Арт-сопровождение: фотосессия в стиле «История и свет»: Наш фотограф, чьи работы публикуются в журналах о путешествиях, не просто сделает снимки, а создаст для вас портфолио в духе художественной исторической хроники. Используя уникальное «закатное» освещение среди древних руин, он запечатлеет ваше путешествие как повествование, полное эстетики и эмоций.',
    'addons.ayutthaya.dinner': 'Гастрономический опыт: ужин в ресторане Rongros (на персону, включены напитки): Мы забронируем для вас столик в знаменитом ресторане Rongros (🌟 Michelin), расположенном в историческом районе Раттанакосин прямо на набережной реки Чао Прайя. Вы сможете насладиться аутентичной тайской кухней высочайшего уровня с видом на храм Ват Арун в лучах заходящего солнца - идеальное завершение дня.',
    'addons.ayutthaya.guide': 'Углубленная программа: гид-эксперт по наследию Аюттхаи: Вашим гидом будет признанный эксперт, автор научных работ или приглашенный лектор, который откроет для вас тайны, не описанные в путеводителях. Эта опция включает доступ к одному из малоизвестных исторических объектов по предварительному согласованию и детальный анализ артефактов.',
    
    // Floating Markets Add-ons
    'addons.floating.photo': 'Арт-сопровождение: Фоторепортаж в духе тревел-журналистики: Наш фотограф, специализирующийся на документальной и travel-съемке, создаст для вас не постановочные фото, а живую и эмоциональную историю в картинках. Вы получите серию снимков, передающих подлинную атмосферу рынка, краски товаров и характеры местных жителей.',
    'addons.floating.breakfast': 'Гастрономический старт дня: Завтрак в отеле Mandarin Oriental Bangkok (на персону): Начните свой день с изысканного завтрака в легендарном отеле Mandarin Oriental. В ресторане The Veranduh вас ждет роскошный шведский стол с блюдами интернациональной и тайской кухни высочайшего класса, сервированный с безупречным вниманием к деталям перед отправлением в тур.',
    'addons.floating.transport': 'Безупречный трансфер: Премиальный минивэн Mercedes-Benz V-Class: Ваше путешествие до рынка и обратно будет проходить с максимальным комфортом в просторном и бесшумном минивэне Mercedes-Benz V-Class. Кондиционированный салон, кожаные сиденья и профессиональный водитель гарантируют расслабляющую и плавную поездку по живописным пригородным дорогам.',
    
    // Temples Add-ons
    'addons.temples.photo': 'Арт-сопровождение: Фотосессия «Диалог с вечностью»: Наш фотограф, специализирующийся на художественной и архитектурной съемке, создаст для вас портфолио, где вы станете частью сакрального пространства. Используя игру света и тени в храмовых комплексах, он запечатлеет моменты глубокого погружения в культуру, создав timeless-фотографии в эстетике высокого искусства.',
    'addons.temples.meditation': 'Глубокое погружение: Медитация с монахом-наставником: Это не групповое занятие, а личная аудиенция и духовная консультация. Вы проведете необходимое количество времени в уединенной келье или саду храма с монахом, который ответит на все ваши вопросы о жизни и философии Дхармы и обучит вас персональным техникам медитации с учетом ваших запросов.',
    'addons.temples.transport': 'Премиальный трансфер: Бизнес-внедорожник Lexus LX: Передвигайтесь по оживленному Бангкоку в безупречном комфорте и тишине на роскошном внедорожнике Lexus LX. Просторный салон с климат-контролем, кожаная отделка и услуги профессионального водителя обеспечат состояние безмятежности и плавный переход между мирской суетой и духовными оазисами.',
    
    // Tribes Add-ons
    'addons.tribes.photo': 'Документальная фотосъемка: «Хранители традиций»: Наш фотограф, работающий в жанре документальной антропологии, создаст для вас уникальный фотодневник. Это будут не постановочные кадры, а пронзительная художественная летопись вашего путешествия — портреты мастеров за работой, моменты ритуалов и пейзажи затерянных миров, достойные публикации.',
    'addons.tribes.accommodation': 'Эко-люкс размещение: Private Rainforest Camp (за всю экспедицию): Откажитесь от стандартных гестхаусов в пользу приватного эко-кемпинга премиум-класса. Ваше размещение — это роскошная палатка с кроватью king-size, собственной ванной комнатой с душем и панорамным видом на джунгли. Вечером вас ждет ужин при свечах и джакузи под звездным небом.',
    'addons.tribes.chef': 'Гастрономический опыт: Персональный шеф-повар (за всю экспедицию): Забудьте о стандартных групповых обедах. На протяжении всей экспедиции ваше питание будет курировать персональный повар, который приготовит для вас блюда высокой тайской кухни из локальных продуктов. Вы сможете участвовать в мастер-классах по приготовлению традиционных блюд горных племен в формате приватного кулинарного шоу на природе.',
