...
const translations: Translations = {
  ...
  ru: {
    ...
    'about.content': 'АРХИПЕЛАГ представляет вершину люкс-консьерж услуг в Таиланде. Благодаря обширным местным связям и непоколебимой приверженности дискретности, мы предоставляем нашим взыскательным клиентам доступ к необыкновенному. Наша экспертиза охватывает все аспекты управления роскошным образом жизни, обеспечивая безупречный опыт, превышающий ожидания.',
    ...
    'testimonials.1': 'Исключительный сервис с непревзойденным вниманием к деталям. АРХИПЕЛАГ превратил наш опыт в Таиланде во что-то поистине необыкновенное.',
    ...
    'testimonials.4': 'Местные связи АРХИПЕЛАГ открыли двери, о существовании которых мы даже не знали. Бесценный партнер для роскошных впечатлений.',
